      ...
      <div className='bg-white/35 rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>
        ...
        <div className='py-10'>
          ...
          <div className='flex flex-col items-center'>
            ...
            <div className='bg-gray-100 w-64 p-2 flex items-center mb-3'>
              <MdLockOutline className='text-gray-400 m-2' />
              <input type="password" placeholder='Confirm Password' name='email' id=''className='bg-gray-100 outline-none text-sm flex-1' />
            </div>
        ...
        <div className='w-2/5 bg-green-50 text-white rounded-tr-2xl rounded-br-2xl py-36 px-4'>
          ...
          <p className='mb-10'>You can use your registered account with us.</p>
          <Link href={'/login'} className='border-2 border-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white hover:text-green-50'>
            Sign in
          </Link>
        </div>
        {/* Sign Up section */}
